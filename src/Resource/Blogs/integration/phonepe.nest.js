...
export default function PhonePeNest() {
...
`}{" "}
                            ...
                            <div id="section7">
                                ...
                                <SyntaxHighlighter>
                                    {`
private async base64ToSha256(base64Data: string): Promise<string> {
    return new Promise((resolve, reject) => {
      try {
        const sha256Hash = crypto.createHash('sha256');
        sha256Hash.update(base64Data);
...
`}
                                ...
                                <div id="section8">
                                    ...
                                    <p>Final Computation:
                                        SHA256</p>
                                    <SyntaxHighlighter>
                                        {`const base64Encode = Buffer.from(JSON.stringify(requestPayload)).toString('base64');
const newBase64 = base64Encode + "/pg/v1/pay" + process.env.PHONEPE_SALT_KEY
const X_Verify = newBase64 + ### + Index_Key 
`}
                                    </SyntaxHighlighter>
